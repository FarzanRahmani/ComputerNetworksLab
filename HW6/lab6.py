...
def run():
    ...
    """
        ...
        bw = None,
 		...
 		max_queue_size = None 
    """
    link_r1sw2.intf1.config( bw=10, enable_red=True , enable_ecn=True) # bandwidth = 10 Mbps
    ...
    r1.cmd('echo 1 > /proc/sys/net/ipv4/ip_forward') # write '1' in file /proc/sys/net/ipv4/ip_forward
    h1.cmd('ip route add default via 10.10.0.10') # default gateway (first hop router)
