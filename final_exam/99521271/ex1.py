...
def run():
    ...
    info('\n** Adding Hosts\n')
    # Q1
    r1 = net.addHost('r1', ip='96.57.19.5/24', hostname='r1',  privateLogDir=True, privateRunDir=True, inMountNamespace=True, inPIDNamespace=True, inUTSNamespace=True)
    h1 = net.addHost('h1', ip='96.57.19.1/24', hostname='h1',  privateLogDir=True, privateRunDir=True, inMountNamespace=True, inPIDNamespace=True, inUTSNamespace=True)
    h2 = net.addHost('h2', ip='96.57.19.2/24', hostname='h2',  privateLogDir=True, privateRunDir=True, inMountNamespace=True, inPIDNamespace=True, inUTSNamespace=True)
    h3 = net.addHost('h3', ip='96.57.80.3/24', hostname='h3',  privateLogDir=True, privateRunDir=True, inMountNamespace=True, inPIDNamespace=True, inUTSNamespace=True)
    h4 = net.addHost('h4', ip='96.57.80.4/24', hostname='h4',  privateLogDir=True, privateRunDir=True, inMountNamespace=True, inPIDNamespace=True, inUTSNamespace=True)
    ...
    # Q1
    r1.cmd('ifconfig r1-eth1 96.57.80.5 netmask 255.255.255.0')
    r1.cmd('echo 1 > /proc/sys/net/ipv4/ip_forward')
    h1.cmd('ip route add default via 96.57.19.5')
    h2.cmd('ip route add default via 96.57.19.5')
    h3.cmd('ip route add default via 96.57.80.5')
    h4.cmd('ip route add default via 96.57.80.5')

    # Q2
    # hide h1 from h3 when h1 ping h3
    r1.cmd('iptables -t nat -A POSTROUTING -p ICMP -s 96.57.19.1 -d 96.57.80.3 -j SNAT --to 96.57.80.5')
    r1.cmd('iptables -t nat -A PREROUTING -p ICMP -s 96.57.80.3 -d 96.57.80.5 -j DNAT --to 96.57.19.1')
